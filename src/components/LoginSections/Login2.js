  ...
  return (
    <section className='w-100 d-flex flex-column justify-content-center login-form-section'>
        ...
        <div className='d-flex justify-content-center gap-4'>
          ...
          <button className='py-2 px-2 rounded-3 border border-2 border-dark bg-dark mb-4 d-flex gap-3 justify-content-center text-body-secondary'><FontAwesomeIcon icon={faApple} className='text-white'/></button>
        </div>
